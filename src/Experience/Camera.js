...
import { OrbitControls } from "three/examples/jsm/controls/OrbitControls.js"; // Three内置的相机控制器类
import gsap from "gsap";

export default class Camera {
  constructor() {
    // 直接从主体类那里获取实例及其主要属性，要是打乱了类的初始化，那么项目绝对会报错，感觉是一个待优化点 ??
    ...
    // 根据当前设备是横向还是纵向调整了一些参数，但是目前不知道aboutMeDistance、projectsDistance是用来干嘛的 ??
